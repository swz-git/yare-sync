...
o.lib=o.prototype={toastify:"1.11.2",constructor:o,
...
this.options.escapeMarkup=void 0!==t.escapeMarkup?t.escapeMarkup:o.defaults.escapeMarkup,this.options.style=t.style||o.defaults.style,t.backgroundColor&&(this.options.style.background=t.backgroundColor),this},
...
console.warn('DEPRECATION NOTICE: "backgroundColor" is being deprecated. Please use the "style.background" property.'),this.options.style)t.style[o]=this.options.style[o]

;// Adding the toast message/node
if(this.options.node&&this.options.node.nodeType===Node.ELEMENT_NODE)
// If we have a valid node, we insert it
t.appendChild(this.options.node)
else if(this.options.escapeMarkup?t.innerText=this.options.text:t.innerHTML=this.options.text,""!==this.options.avatar){var e=document.createElement("img")
e.src=this.options.avatar,e.className="toastify-avatar","left"==this.options.position||!0===this.options.positionLeft?
...
s.innerHTML="&#10006;",s.className="toast-close",
// Triggering the removal of toast from DOM on close click
s.addEventListener("click",function(t){t.stopPropagation(),this.removeElement(this.toastElement),window.clearTimeout(this.toastElement.timeOutValue)}.bind(this))
...
if(this.options.stopOnFocus&&this.options.duration>0){var a=this
...
a.removeElement(t)}),a.options.duration)}))}
// Adding an on-click destination path
// Adding offset
if(void 0!==this.options.destination&&t.addEventListener("click",function(t){t.stopPropagation(),!0===this.options.newWindow?window.open(this.options.destination,"_blank"):window.location=this.options.destination}.bind(this)),"function"==typeof this.options.onClick&&void 0===this.options.destination&&t.addEventListener("click",function(t){t.stopPropagation(),this.options.onClick()}.bind(this)),"object"==typeof this.options.offset){var l=i("x",this.options),d=i("y",this.options),r="left"==this.options.position?l:"-"+l,c="toastify-top"==this.options.gravity?d:"-"+d
t.style.transform="translate("+r+","+c+")"}
...
this.toastElement=this.buildToast(),!(t="string"==typeof this.options.selector?document.getElementById(this.options.selector):this.options.selector instanceof HTMLElement||"undefined"!=typeof ShadowRoot&&this.options.selector instanceof ShadowRoot?this.options.selector:document.body))throw"Root element is not defined"
...
// @ts-ignore
window.update_code(),l({text:"Updated your code!",backgroundColor:"linear-gradient(90deg, rgba(49,194,0,1) 0%, rgba(48,255,0,1) 100%)"}).showToast()})).catch((t=>{}))}),2e3)}function r(){return o(this,void 0,void 0,(function*(){t("Document loaded, starting yare-sync...","color:orange"),l({text:"Loaded yare-sync"}).showToast(),document.head.innerHTML+='<link rel="stylesheet" type="text/css" href="data:text/css;base64,"></link>',d()}))}t("Loaded yare-sync","color:orange"),
//@ts-ignore
...
//@ts-ignore
clearInterval(globalThis.loadcheckinterval),r.bind(globalThis)())}),50)
